 ...
 * <p/>
 * purpose:
 * This class tracks the path of the user.
 * Google map is used in this class.
 * Also the latitude and longitude of the location is used to track the location path.
 */
...
public class GeoLocator extends FragmentActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_geo_locator);
        getMapReference();
    }
